 ...
 * Generated at: 2026-09-13T07:07:34.697Z
 *
...
export const TABLES = {
  ...
  table36: {
    name: 'audit_logs',
    displayName: '시스템 감사 로그 대장',
    description: '시스템 감사 로그 대장',
    rowCount: 0,
    columnCount: 10,
    columns: ['id', '_version', 'user_id', 'user_role', 'activity_type', 'quotation_case_id', 'case_name', 'details', 'ip_address', 'created_at']
  } as TableDefinition
} as const;
...
export const TABLE_NAMES = {
  ...
  table5: 'golden_cases',
  table6: 'cad_app_settings',
  table7: 'case_archives',
  table8: 'quote_exports',
  table9: 'excel_templates',
  table10: 'manual_price_pool',
  table11: 'quote_items',
  table12: 'quotes',
  table13: 'price_masters',
  table14: 'final_bom_items',
  table15: 'bom_approval_records',
  table16: 'master_candidates',
  table17: 'master_aliases',
  table18: 'product_masters',
  table19: 'normalized_bom_items',
  table20: 'flattened_bom_items',
  table21: 'raw_bom_items',
  table22: 'bom_areas',
  table23: 'drawing_relationships',
  table24: 'drawings',
  table25: 'cad_objects',
  table26: 'cad_parse_runs',
  table27: 'dwg_conversion_runs',
  table28: 'uploaded_files',
  table29: 'quotation_cases',
  table30: 'projects',
  table31: 'user_company_access',
  table32: 'companies',
  table33: 'users',
  table34: 'system_settings',
  table35: 'user_activity_logs',
  table36: 'audit_logs'
} as const;
