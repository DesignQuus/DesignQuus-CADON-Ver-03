 ...
 * | Render / egdesk.cloud tunnel URL     | {MCP root}/t/{id}/visitor-auth/callback/{id}|
 * | Custom domain (yourdomain.com)       | https://{domain}/visitor-auth/callback/{id}   |
 *
...
export function resolveEgdeskPublicUrl(): string {
  ...
  // Custom domains (sheetbot.cloud) bounce at {origin}/visitor-auth/callback/{id} — no /t/ prefix.
