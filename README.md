...
시스템 초기화 시 마스터 데이터 및 테스트용 사용자 계정이 자동으로 시딩됩니다:

| 역할 (Role) | 아이디 (Login ID) | 비밀번호 (Password) | 비고 |
| :--- | :--- | :--- | :--- |
| **시스템 최고관리자** | `admin` | `Cadon1234!@` | 전체 견적/단가/사용자/감사로그 관리 |
| **영업1팀 담당자** | `sales1` | `Cadon1234!@` | 견적 건 생성, 부품 매핑 및 검토 |
| **영업담당 과장** | `kim` | `Cadon1234!@` | 견적 건 생성, 부품 매핑 및 검토 |
| **영업담당 대리** | `lee` | `Cadon1234!@` | 견적 건 생성, 부품 매핑 및 검토 |
